...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rugged>.freeze, ["~> 0.24", ">= 0.23.0"])
      s.add_runtime_dependency(%q<thor>.freeze, ["~> 0.19.0"])
      s.add_runtime_dependency(%q<octokit>.freeze, ["~> 4.7", ">= 4.7.0"])
      s.add_runtime_dependency(%q<gitlab>.freeze, ["~> 4.0", ">= 4.0.0"])
      ...
      s.add_dependency(%q<rugged>.freeze, ["~> 0.24", ">= 0.23.0"])
      s.add_dependency(%q<thor>.freeze, ["~> 0.19.0"])
      s.add_dependency(%q<octokit>.freeze, ["~> 4.7", ">= 4.7.0"])
      s.add_dependency(%q<gitlab>.freeze, ["~> 4.0", ">= 4.0.0"])
